...
function calculator(button) {
    if(button.type == "operator") {
        ...
        /*Get Power Base and replace bases with right formula*/
        ...
        /*Get Factorial number and replace bases with right formula*/
...
function factorialNumberGetter(formula, FACTORIAL_SEARCH_RESULT) {
    ...
    FACTORIAL_SEARCH_RESULT.forEach( factorial_index => {
        ...
        //Then to add number right before it
...
function updateOutputResult(result) {
    ...
    if(result === Infinity){
        ...
        output_result_element.innerHTML = "Syntax Error!";
    }else{
        output_result_element.innerHTML = result;
    }  
}
